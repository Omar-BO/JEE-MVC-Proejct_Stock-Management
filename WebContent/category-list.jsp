                	...
                	<div class="card">
			        	<div class="card-header card-header-primary">
			            	...
			            	<div class="container text-left" >
			            		<a href="<%=request.getContextPath()%>/category?page=new" class="btn btn-success">Add New Category</a>
							</div>
			            </div>
						<div class="card-body">
			            	<div class="table-responsive">
								...
								<tr>
									...
									<td><c:out value="${category.getLabel()}" /></td>
									<td><c:out value="${category.getDescription()}" /></td>									
									<td>
									<a class="pen-icon" href="category?page=edit&id=<c:out value='${category.getIdCategory()}' />">
									...
									&nbsp;&nbsp;&nbsp;&nbsp;
									<a class="trash-icon" href="category?page=delete&id=<c:out value='${category.getIdCategory()}' />">
