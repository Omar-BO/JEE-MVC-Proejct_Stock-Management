                	...
                	<div class="card">
			        	<div class="card-header card-header-primary">
			            	...
			            	<div class="container text-left" >
			            		<a href="<%=request.getContextPath()%>/user?page=new" class="btn btn-success">Add New User</a>
							</div>
			            </div>
						<div class="card-body">
			            	<div class="table-responsive">
								...
								<tr>
									...
									<td>
									<a class="pen-icon" href="user?page=edit&id=<c:out value='${user.getIdUser()}' />">
									...
									&nbsp;&nbsp;&nbsp;&nbsp;
									<a class="trash-icon" href="user?page=delete&id=<c:out value='${user.getIdUser()}' />">
