                	...
                	<div class="card">
			        	<div class="card-header card-header-primary">
			            	...
			            	<div class="container text-left" >
			            		<a href="<%=request.getContextPath()%>/product?page=new" class="btn btn-success">Add New Product</a>
							</div>
			            </div>
						<div class="card-body">
			            	<div class="table-responsive">
								...
								<tr>
									...
									<td><c:out value="${product['VAT']}" /></td>
									<td><c:out value="${product['idCategory']}" /></td>
									<td><c:out value="${product['idProvider']}" /></td>
									<td>
									<a class="pen-icon" href="product?page=edit&id=<c:out value="${product['id']}" />">
									...
									&nbsp;&nbsp;&nbsp;&nbsp;
									<a class="trash-icon" href="product?page=delete&id=<c:out value="${product['id']}" />">
