...
<div class="wrapper ">
  ...
  <div class="main-panel">
	<header>
		...
		<ul class="navbar-nav">
			<li><a href="<%=request.getContextPath()%>/category" class="nav-link">Categories</a></li>
		</ul>
		...
		<div class="card">
			<div class="card-body" >
				<c:if test="${category != null}">
					<form action="category?page=update" method="post">
				</c:if>
				<c:if test="${category == null}">
					<form action="category?page=insert" method="post">
				</c:if>
				...
				<c:if test="${category != null}">
					<input type="hidden" name="id" value="<c:out value='${category.getIdCategory()}' />" />
				</c:if>

				<fieldset class="form-group">
					<b><label>Label</label></b> <input type="text"
						value="<c:out value='${category.getLabel()}' />" class="form-control"
						name="label" required="required">
				</fieldset>

				<fieldset class="form-group">
					<b><label>Description</label></b> <input type="text"
						value="<c:out value='${category.getDescription()}' />" class="form-control"
